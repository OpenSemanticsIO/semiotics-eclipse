    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Entitlement_accounts_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Entitlement_accounts_feature", "_UI_Entitlement_type"),
         AssessmentPackage.Literals.ENTITLEMENT__ACCOUNTS,
         true,
         false,
         true,
         null,
