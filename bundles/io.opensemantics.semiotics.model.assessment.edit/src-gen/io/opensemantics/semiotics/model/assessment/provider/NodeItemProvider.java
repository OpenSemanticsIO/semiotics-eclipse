...
/**
 * This is the item provider adapter for a {@link io.opensemantics.semiotics.model.assessment.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
   ...
   */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Node_tasks_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Node_tasks_feature", "_UI_Node_type"),
         AssessmentPackage.Literals.NODE__TASKS,
         true,
         false,
         true,
         null,
   ...
   */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Node_findings_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Node_findings_feature", "_UI_Node_type"),
         AssessmentPackage.Literals.NODE__FINDINGS,
         true,
         false,
         true,
         null,
