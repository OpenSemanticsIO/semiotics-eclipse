  ...
  protected void addInternalURLPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Application_internalURL_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Application_internalURL_feature", "_UI_Application_type"),
         AssessmentPackage.Literals.APPLICATION__INTERNAL_URL,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  protected void addExternalURLPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Application_externalURL_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Application_externalURL_feature", "_UI_Application_type"),
         AssessmentPackage.Literals.APPLICATION__EXTERNAL_URL,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    newChildDescriptors.add
      (createChildParameter
        (AssessmentPackage.Literals.APPLICATION__ACCOUNTS,
         AssessmentFactory.eINSTANCE.createAccounts()));

    newChildDescriptors.add
      (createChildParameter
        (AssessmentPackage.Literals.APPLICATION__ENTITLEMENTS,
         AssessmentFactory.eINSTANCE.createEntitlements()));

    newChildDescriptors.add
      (createChildParameter
        (AssessmentPackage.Literals.APPLICATION__CONTROLLERS,
         AssessmentFactory.eINSTANCE.createControllers()));

    newChildDescriptors.add
      (createChildParameter
        (AssessmentPackage.Literals.APPLICATION__MODELS,
         AssessmentFactory.eINSTANCE.createModels()));

    newChildDescriptors.add
      (createChildParameter
        (AssessmentPackage.Literals.APPLICATION__VIEWS,
         AssessmentFactory.eINSTANCE.createViews()));

    newChildDescriptors.add
      (createChildParameter
        (AssessmentPackage.Literals.APPLICATION__SINKS,
         AssessmentFactory.eINSTANCE.createSinks()));

    newChildDescriptors.add
      (createChildParameter
        (AssessmentPackage.Literals.APPLICATION__RESOURCES,
         AssessmentFactory.eINSTANCE.createResources()));
  }
