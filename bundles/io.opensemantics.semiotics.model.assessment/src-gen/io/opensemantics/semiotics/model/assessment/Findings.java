...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Findings</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link io.opensemantics.semiotics.model.assessment.Findings#getFindings <em>Findings</em>}</li>
 *   <li>{@link io.opensemantics.semiotics.model.assessment.Findings#getAssessment <em>Assessment</em>}</li>
 * </ul>
 *
 * @see io.opensemantics.semiotics.model.assessment.AssessmentPackage#getFindings()
 * @model
 * @generated
 */
public interface Findings extends EObject {
	/**
   ...
   * It is bidirectional and its opposite is '{@link io.opensemantics.semiotics.model.assessment.Finding#getFindings <em>Findings</em>}'.
   * <!-- begin-user-doc -->
	 * <p>
   ...
   * @see io.opensemantics.semiotics.model.assessment.AssessmentPackage#getFindings_Findings()
   * @see io.opensemantics.semiotics.model.assessment.Finding#getFindings
   * @model opposite="findings" containment="true"
   * @generated
   */
   ...
   * @see io.opensemantics.semiotics.model.assessment.AssessmentPackage#getFindings_Assessment()
   ...
   */
	...
	/**
   * Sets the value of the '{@link io.opensemantics.semiotics.model.assessment.Findings#getAssessment <em>Assessment</em>}' container reference.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
