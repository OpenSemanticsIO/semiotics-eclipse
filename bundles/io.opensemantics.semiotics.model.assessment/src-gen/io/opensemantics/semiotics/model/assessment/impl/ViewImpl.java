 ...
 * </p>
 * <ul>
 *   <li>{@link io.opensemantics.semiotics.model.assessment.impl.ViewImpl#getApplication <em>Application</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewImpl extends GraphImpl<Node> implements View {
	...
	public Application getApplication() {
		if (eContainerFeatureID() != AssessmentPackage.VIEW__APPLICATION) return null;
	...
	public NotificationChain basicSetApplication(Application newApplication, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newApplication, AssessmentPackage.VIEW__APPLICATION, msgs);
		return msgs;
	}
	...
	public void setApplication(Application newApplication) {
		if (newApplication != eInternalContainer() || (eContainerFeatureID() != AssessmentPackage.VIEW__APPLICATION && newApplication != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AssessmentPackage.VIEW__APPLICATION, newApplication, newApplication));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AssessmentPackage.VIEW__APPLICATION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
