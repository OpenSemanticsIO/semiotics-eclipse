 ...
 * </p>
 * <ul>
 *   <li>{@link io.opensemantics.semiotics.model.assessment.impl.GraphImpl#getRoot <em>Root</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GraphImpl<T extends Node> extends MinimalEObjectImpl.Container implements Graph<T> {
	...
	public void setRoot(T newRoot) {
		if (newRoot != root) {
			...
			if (root != null)
				msgs = ((InternalEObject)root).eInverseRemove(this, AssessmentPackage.NODE__GRAPH, Node.class, msgs);
			if (newRoot != null)
				msgs = ((InternalEObject)newRoot).eInverseAdd(this, AssessmentPackage.NODE__GRAPH, Node.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AssessmentPackage.GRAPH__ROOT:
				...
				return basicSetRoot((T)otherEnd, msgs);
		}
